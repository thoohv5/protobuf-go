...
import (
	...
	"github.com/thoohv5/protobuf-go/types/pluginpb"
)
...
func (opts Options) New(req *pluginpb.CodeGeneratorRequest) (*Plugin, error) {
	...
	//
	//     option go_package = "github.com/thoohv5/protobuf-go/types/known/anypb";
	//
...
// For example: "github.com/thoohv5/protobuf-go/compiler/protogen"
