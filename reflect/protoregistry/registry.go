...
//
//	go build -ldflags "-X github.com/thoohv5/protobuf-go/reflect/protoregistry.conflictPolicy=warn"
//
...
func (r *Files) checkGenProtoConflict(path string) {
	...
	currPath := "github.com/thoohv5/protobuf-go/types/known/" + pkgName
	panic(fmt.Sprintf(""+
